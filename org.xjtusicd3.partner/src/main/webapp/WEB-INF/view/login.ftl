...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="saveLogin.html"  method="post">
                <div class="form-group">
                    <input type="username" class="form-control" placeholder="用户名" name="nameOrEmail" required="">
                </div>
                <div class="form-group">
                ...
                <p class="text-muted text-center"> <a href="login.html#"><small>还没有注册？</small></a> | <a href="register.html">注册一个新账号</a>
                </p>
